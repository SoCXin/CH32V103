...
//-----------------引脚定义------------------------------
#define IPS114_SPIN             SPI_1           //定义使用的SPI号
#define IPS114_SCL_PIN          SPI1_SCK_PA5    //定义SPI_SCK引脚
#define IPS114_SDA_PIN          SPI1_MOSI_PA7   //定义SPI_MOSI引脚
#define IPS114_SDA_IN_PIN       SPI_MISO_NULL   //定义SPI_MISO引脚
...
#define IPS114_BL_PIN           PIN_NULL        //液晶背光引脚定义
